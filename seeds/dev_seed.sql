...
ON CONFLICT (piston_alias, piston_version) DO NOTHING;
...
-- GitHub account (commented example — uncomment and fill in for real GitHub integration)
-- INSERT INTO github_accounts (user_id, installation_id, github_user_id, github_username, github_owner, github_owner_type)
-- VALUES (1, '12345678', '987654321', 'your-username', 'your-username', 'User');
