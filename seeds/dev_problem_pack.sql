...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM test_cases WHERE problem_id = pid LIMIT 1) THEN
        INSERT INTO test_cases (problem_id, visibility, input_data, expected_output, order_index) VALUES
            ...
            (pid, 'hidden', '1\n5', 'false', 3),
            (pid, 'hidden', '6\n1 1 1 2 2 3', 'true', 4),
            (pid, 'hidden', '3\n1000000000 -1000000000 0', 'false', 5);
    END IF;
END $$;
...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM test_cases WHERE problem_id = pid LIMIT 1) THEN
        INSERT INTO test_cases (problem_id, visibility, input_data, expected_output, order_index) VALUES
            (pid, 'sample', 'hello', 'olleh', 1),
            (pid, 'sample', 'JavaScript', 'tpircSavaJ', 2),
            (pid, 'hidden', 'a', 'a', 3),
            (pid, 'hidden', 'racecar', 'racecar', 4),
            (pid, 'hidden', '12345', '54321', 5);
    END IF;
END $$;
...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM test_cases WHERE problem_id = pid LIMIT 1) THEN
        INSERT INTO test_cases (problem_id, visibility, input_data, expected_output, order_index) VALUES
            (pid, 'sample', '121', 'true', 1),
            (pid, 'sample', '-121', 'false', 2),
            (pid, 'hidden', '10', 'false', 3),
            (pid, 'hidden', '0', 'true', 4),
            (pid, 'hidden', '123454321', 'true', 5);
    END IF;
END $$;
...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM test_cases WHERE problem_id = pid LIMIT 1) THEN
        INSERT INTO test_cases (problem_id, visibility, input_data, expected_output, order_index) VALUES
            (pid, 'sample', 'hello', '2', 1),
            (pid, 'sample', 'JavaScript', '3', 2),
            (pid, 'hidden', 'aeiou', '5', 3),
            (pid, 'hidden', 'AEIOUaeiou', '10', 4),
            (pid, 'hidden', 'bcdfg', '0', 5);
    END IF;
END $$;
